...
export default function FirmSettingsScreen() {
  ...
  const settingsSections = [
    ...
    },
    {
      title: "Facturacion",
      items: [
        { icon: "card-outline", label: "Plan y Facturacion", onPress: () => Alert.alert("Plan", "Plan Empresarial activo") },
      ],
    },
    {
      title: "Notificaciones",
      items: [
        { icon: "notifications-outline", label: "Configurar Notificaciones", onPress: () => Alert.alert("Proximamente", "Esta funcion estara disponible pronto.") },
      ],
    },
    {
      title: "Aplicacion",
